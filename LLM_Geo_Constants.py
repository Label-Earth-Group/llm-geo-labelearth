...
def assembly_requirement(save_dir):
    requirement = ['You can think step by step. ',
                    ...
                    f"Save final maps, if any, in this folder: {save_dir}. If use matplotlib, the function is: matplotlib.pyplot.savefig(*args, **kwargs).",
...
def debug_requirement(save_dir):
    debug_requirement = [
                        ...
                        "If you need to make a map and the map size is not given, set the map size to 15*10 inches.",
                        f"Save all the final maps in png or jpg files, if any, in this folder: {save_dir}.",
                        ]
